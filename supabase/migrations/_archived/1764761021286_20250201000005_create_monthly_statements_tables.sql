...
CREATE TABLE IF NOT EXISTS statement_reconciliations (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    monthly_statement_id UUID NOT NULLid) ON DELETE CASCADE,
    company_id UUID NOT NULL REFERENCES companies(id) ON DELETE CASCADE,
    site_id UUID NOT NULL REFERENCES sites(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS reconciliation_discrepancies (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    statement_reconciliation_id UUID NOT NULLid) ON DELETE CASCADE,
    company_id UUID NOT NULL REFERENCES companies(id) ON DELETE CASCADE,
    site_id UUID NOT NULL REFERENCES sites(id) ON DELETE CASCADE,
...
-- statement_reconciliations policies
...
-- reconciliation_discrepancies policies
