-- Migration: 20250131000004_create_missing_core_tables.sql
-- Description: Create missing core tables (corrective_actions, runtime_monitoring, escalation_workflows)
-- Author: Build System
-- Date: 2025-01-31
-- Order: Before Phase 4 advanced tables (20250201000001) which enhances these tables
...
-- corrective_actions RLS policies
...
-- runtime_monitoring RLS policies
...
-- escalation_workflows RLS policies
