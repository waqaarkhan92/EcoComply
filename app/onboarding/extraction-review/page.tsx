          ...
          {!reviewed ? (
            <>
              <div className="text-center mb-8">
                ...
                <h1 className="text-3xl font-bold text-text-primary mb-2">Review Extracted Obligations</h1>
                <p className="text-text-secondary">
                  Our AI has extracted obligations from your document. Review them to ensure accuracy.
                </p>
              </div>
              ...
              <div className="bg-background-tertiary rounded-lg p-6 mb-6">
                ...
                <ul className="space-y-2 text-sm text-text-secondary">
                  <li className="flex items-start gap-2">
                    ...
                    <span>Check that all obligations were extracted correctly</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-5 w-5 text-success flex-shrink-0 mt-0.5" />
                    <span>Verify dates and deadlines are accurate</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-5 w-5 text-success flex-shrink-0 mt-0.5" />
              ...
              <div className="bg-warning/10 border border-warning rounded-lg p-4 mb-6">
                <p className="text-sm text-warning">
                  <strong>Tip:</strong> You can review and edit obligations later in the Review Queue. For now, let's continue with the tutorial.
                </p>
              </div>
            ...
            <div className="text-center py-8">
              ...
              <h2 className="text-2xl font-bold text-text-primary mb-2">Great!</h2>
              <p className="text-text-secondary">
