...
export default function ExcelImportPage() {
  ...
  const uploadMutation = useMutation({
    ...
    onSuccess: async (data) => {
      ...
      // Wait a moment then redirect to import preview
      setTimeout(() => {
      ...
      <div className="w-full max-w-2xl">
        ...
        <div className="bg-white rounded-lg shadow-base p-8">
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-text-primary mb-2">Import from Excel</h1>
            <p className="text-text-secondary">
              Upload your Excel spreadsheet with obligations. We'll import them into the system.
            </p>
          </div>
          ...
          {!uploaded ? (
            <>
              ...
              <div className="bg-background-tertiary rounded-lg p-4 mb-6">
                <p className="text-sm text-text-secondary">
                  <strong>Required columns:</strong> Obligation Title, Category, Frequency, Deadline Date
                </p>
              </div>
            ...
            <div className="text-center py-8">
              ...
              <h2 className="text-2xl font-bold text-text-primary mb-2">File Uploaded!</h2>
              <p className="text-text-secondary mb-4">
                Your Excel file is being processed. Review the preview next.
              </p>
