    ...
    <div className="space-y-6">
            ...
            <table className="w-full">
              ...
              <tbody>
                {deadlines.map((deadline) => (
                  <tr key={deadline.id} className="border-b border-input-border/50">
      ...
      <div className="bg-white rounded-lg shadow-base p-6">
        ...
        <div className="flex gap-4">
          ...
          <a href="/dashboard/evidence/upload">
...
function StatusBadge({ status }: { status: string }) {
  const statusConfig = {
    PENDING: { label: 'Pending', className: 'bg-background-secondary text-text-primary' },
