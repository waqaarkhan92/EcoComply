 ...
 * Comprehensive tests for lib/utils/schedule-calculator.ts
 * Target: 100% coverage
 */
...
// TODO: Import functions from 'lib/utils/schedule-calculator.ts'
 ...
 *
 * Steps to complete:
 * 1. Review lib/utils/schedule-calculator.ts and identify all exported functions
 ...
 * 7. Run: npm test -- schedule-calculator.ts
 * 8. Check coverage: npm run test:coverage -- schedule-calculator.ts
