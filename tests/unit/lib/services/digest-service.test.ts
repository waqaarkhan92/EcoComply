 ...
 * Comprehensive tests for lib/services/digest-service.ts
 * Target: 100% coverage
 */
...
// TODO: Import functions from 'lib/services/digest-service.ts'
 ...
 *
 * Steps to complete:
 * 1. Review lib/services/digest-service.ts and identify all exported functions
 ...
 * 7. Run: npm test -- digest-service.ts
 * 8. Check coverage: npm run test:coverage -- digest-service.ts
