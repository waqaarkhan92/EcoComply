/**
 * refresh-compliance-dashboard-job Tests
 * Comprehensive tests for lib/jobs/refresh-compliance-dashboard-job.ts
 * Target: 100% coverage
 */
...
// TODO: Import functions from 'lib/jobs/refresh-compliance-dashboard-job.ts'

describe('refresh-compliance-dashboard-job', () => {
  beforeEach(() => {
    jest.clearAllMocks();
  });
 ...
 *
 * Steps to complete:
 * 1. Review lib/jobs/refresh-compliance-dashboard-job.ts and identify all exported functions
 ...
 * 7. Run: npm test -- refresh-compliance-dashboard-job.ts
 * 8. Check coverage: npm run test:coverage -- refresh-compliance-dashboard-job.ts
