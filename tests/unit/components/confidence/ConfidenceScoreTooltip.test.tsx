/**
 * ConfidenceScoreTooltip.tsx Tests
 * Comprehensive tests for components/confidence/ConfidenceScoreTooltip.tsx
 * Target: 100% coverage
 */
...
// TODO: Import functions from 'components/confidence/ConfidenceScoreTooltip.tsx'

describe('ConfidenceScoreTooltip.tsx', () => {
  beforeEach(() => {
    jest.clearAllMocks();
  });
 ...
 *
 * Steps to complete:
 * 1. Review components/confidence/ConfidenceScoreTooltip.tsx and identify all exported functions
 ...
 * 7. Run: npm test -- ConfidenceScoreTooltip.tsx
 * 8. Check coverage: npm run test:coverage -- ConfidenceScoreTooltip.tsx
