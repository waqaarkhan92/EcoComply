/**
 * UnlinkedEvidenceWidget.tsx Tests
 * Comprehensive tests for components/dashboard/UnlinkedEvidenceWidget.tsx
 * Target: 100% coverage
 */
...
// TODO: Import functions from 'components/dashboard/UnlinkedEvidenceWidget.tsx'

describe('UnlinkedEvidenceWidget.tsx', () => {
  beforeEach(() => {
    jest.clearAllMocks();
  });
 ...
 *
 * Steps to complete:
 * 1. Review components/dashboard/UnlinkedEvidenceWidget.tsx and identify all exported functions
 ...
 * 7. Run: npm test -- UnlinkedEvidenceWidget.tsx
 * 8. Check coverage: npm run test:coverage -- UnlinkedEvidenceWidget.tsx
