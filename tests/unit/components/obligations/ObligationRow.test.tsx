/**
 * ObligationRow.tsx Tests
 * Comprehensive tests for components/obligations/ObligationRow.tsx
 * Target: 100% coverage
 */
...
// TODO: Import functions from 'components/obligations/ObligationRow.tsx'

describe('ObligationRow.tsx', () => {
  beforeEach(() => {
    jest.clearAllMocks();
  });
 ...
 *
 * Steps to complete:
 * 1. Review components/obligations/ObligationRow.tsx and identify all exported functions
 ...
 * 7. Run: npm test -- ObligationRow.tsx
 * 8. Check coverage: npm run test:coverage -- ObligationRow.tsx
