/**
 * ObligationCard.tsx Tests
 * Comprehensive tests for components/obligations/ObligationCard.tsx
 * Target: 100% coverage
 */
...
// TODO: Import functions from 'components/obligations/ObligationCard.tsx'

describe('ObligationCard.tsx', () => {
  beforeEach(() => {
    jest.clearAllMocks();
  });
 ...
 *
 * Steps to complete:
 * 1. Review components/obligations/ObligationCard.tsx and identify all exported functions
 ...
 * 7. Run: npm test -- ObligationCard.tsx
 * 8. Check coverage: npm run test:coverage -- ObligationCard.tsx
