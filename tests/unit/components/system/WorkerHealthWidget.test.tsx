/**
 * WorkerHealthWidget.tsx Tests
 * Comprehensive tests for components/system/WorkerHealthWidget.tsx
 * Target: 100% coverage
 */
...
// TODO: Import functions from 'components/system/WorkerHealthWidget.tsx'

describe('WorkerHealthWidget.tsx', () => {
  beforeEach(() => {
    jest.clearAllMocks();
  });
 ...
 *
 * Steps to complete:
 * 1. Review components/system/WorkerHealthWidget.tsx and identify all exported functions
 ...
 * 7. Run: npm test -- WorkerHealthWidget.tsx
 * 8. Check coverage: npm run test:coverage -- WorkerHealthWidget.tsx
