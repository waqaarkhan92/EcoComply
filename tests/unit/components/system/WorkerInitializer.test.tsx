/**
 * WorkerInitializer.tsx Tests
 * Comprehensive tests for components/system/WorkerInitializer.tsx
 * Target: 100% coverage
 */
...
// TODO: Import functions from 'components/system/WorkerInitializer.tsx'

describe('WorkerInitializer.tsx', () => {
  beforeEach(() => {
    jest.clearAllMocks();
  });
 ...
 *
 * Steps to complete:
 * 1. Review components/system/WorkerInitializer.tsx and identify all exported functions
 ...
 * 7. Run: npm test -- WorkerInitializer.tsx
 * 8. Check coverage: npm run test:coverage -- WorkerInitializer.tsx
