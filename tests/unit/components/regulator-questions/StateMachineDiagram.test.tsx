/**
 * StateMachineDiagram.tsx Tests
 * Comprehensive tests for components/regulator-questions/StateMachineDiagram.tsx
 * Target: 100% coverage
 */
...
// TODO: Import functions from 'components/regulator-questions/StateMachineDiagram.tsx'

describe('StateMachineDiagram.tsx', () => {
  beforeEach(() => {
    jest.clearAllMocks();
  });
 ...
 *
 * Steps to complete:
 * 1. Review components/regulator-questions/StateMachineDiagram.tsx and identify all exported functions
 ...
 * 7. Run: npm test -- StateMachineDiagram.tsx
 * 8. Check coverage: npm run test:coverage -- StateMachineDiagram.tsx
