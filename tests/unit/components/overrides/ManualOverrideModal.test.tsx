/**
 * ManualOverrideModal.tsx Tests
 * Comprehensive tests for components/overrides/ManualOverrideModal.tsx
 * Target: 100% coverage
 */
...
// TODO: Import functions from 'components/overrides/ManualOverrideModal.tsx'

describe('ManualOverrideModal.tsx', () => {
  beforeEach(() => {
    jest.clearAllMocks();
  });
 ...
 *
 * Steps to complete:
 * 1. Review components/overrides/ManualOverrideModal.tsx and identify all exported functions
 ...
 * 7. Run: npm test -- ManualOverrideModal.tsx
 * 8. Check coverage: npm run test:coverage -- ManualOverrideModal.tsx
